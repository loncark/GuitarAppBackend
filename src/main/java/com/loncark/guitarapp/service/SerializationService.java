...
public class SerializationService {
    public String serializeUserInfo() {
        ...
        try (FileOutputStream fileOut = new FileOutputStream("john.ser");
    ...
    public String serializeMaliciousUserInfo() throws IOException {
        MaliciousUserInfo userInfo = new MaliciousUserInfo(1L, "MaliciousJohn", "johnpassword", "ROLE_ADMIN,ROLE_USER");

        try (FileOutputStream fileOut = new FileOutputStream("john.ser");
             ObjectOutputStream oos = new ObjectOutputStream(fileOut)) {                // try with resources
    ...
    public String deserializeUserInfoSafely() throws IOException {
        try(FileInputStream fin = new FileInputStream("john.ser");
